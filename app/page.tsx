        ...
        <div className="max-w-[1400px] mx-auto px-6 py-16">
          ...
          <div className="border-t border-gray-200 dark:border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm text-gray-400 dark:text-gray-600">
              <span className="hover:text-gray-600 dark:hover:text-gray-400 transition-colors cursor-pointer">Privacy Policy</span>
              <span className="hover:text-gray-600 dark:hover:text-gray-400 transition-colors cursor-pointer">Terms of Service</span>
              <span className="hover:text-gray-600 dark:hover:text-gray-400 transition-colors cursor-pointer">HIPAA Compliance</span>
            </div>
          </div>
        </div>
      </footer>
